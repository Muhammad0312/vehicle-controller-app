...
class PS4Controller implements BaseController {
  @override
  String get id => 'ps4';

  @override
  String get name => 'PS4 Controller';
  ...
  Widget buildUI(
    ...
    return _PS4ControllerUI(onStateChanged: onStateChanged);
  }
}

class _PS4ControllerUI extends ConsumerStatefulWidget {
  final Function(ControllerState) onStateChanged;

  const _PS4ControllerUI({required this.onStateChanged});

  @override
  ConsumerState<_PS4ControllerUI> createState() => _PS4ControllerUIState();
}

class _PS4ControllerUIState extends ConsumerState<_PS4ControllerUI> {
  // State
  ...
  void _updateState() {
    ...
    widget.onStateChanged(
      ControllerState(type: 'ps4', axes: axes, buttons: buttons),
    );
  }
            ...
            children: [
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    _buildTechnicalSmallButton('SHARE', 6),
                    SizedBox(width: 80),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: pressed
              ...
              : Colors.black,
          border: Border.all(
            color: pressed ? Colors.cyanAccent : Colors.white24,
            width: 1.5,
          ),
        ...
        child: Icon(
          icon,
          color: pressed ? Colors.cyanAccent : Colors.white54,
          size: size * 0.6,
        ),
      ),
    );
